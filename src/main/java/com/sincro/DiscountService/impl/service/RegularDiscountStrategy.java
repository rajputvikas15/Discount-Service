...
@Service
public class RegularDiscountStrategy implements CalculateDiscountStrategy {

    private final CustomerTypeRepository customerTypeRepository;

    public RegularDiscountStrategy(CustomerTypeRepository customerTypeRepository) {
    ...
    public Double calculateDiscount(CustomerType customerType, Double bill) {
        ...
        Optional<CustomerTypeEntity>  optionalCustomerTypeEntity = customerTypeRepository.findById("1");
...
class CustomComparator implements Comparator<DiscountSlabEntity> {
    @Override
    public int compare(DiscountSlabEntity o1, DiscountSlabEntity o2) {
        return o1.getSlabStartAmount().compareTo(o2.getSlabStartAmount());
    }
}
